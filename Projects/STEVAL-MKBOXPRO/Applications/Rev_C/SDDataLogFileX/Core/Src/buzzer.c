/**
  ******************************************************************************
  * @file    buzzer.c
  * @brief   Piezo on PE13 driven by TIM1_CH3 PWM. SDDataLogFileX runs sysclk
  *          = 160 MHz with APB2 prescaler = 1, so TIM1 input clock is also
  *          160 MHz. We pick a prescaler that yields a 1 MHz timer tick, then
  *          set the period to 1_000_000 / freq for accurate audio frequency.
  ******************************************************************************
  */
