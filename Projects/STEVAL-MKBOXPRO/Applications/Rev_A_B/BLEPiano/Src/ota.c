...
#define OTA_PRINTF STBOX1_PRINTF
#else /* OTA_ENABLE_PRINTF */
#define OTA_PRINTF(...)
#endif /* OTA_ENABLE_PRINTF */

/* Local Macros --------------------------------------------------------------*/
#define OTA_ERROR_FUNCTION() { STBOX1_Error_Handler(STBOX1_ERROR_FLASH,__FILE__,__LINE__);}
...
static FwId_BoardName_t CurrentFwInfo;
static FwId_BoardName_t OtherBankFwInfo;
