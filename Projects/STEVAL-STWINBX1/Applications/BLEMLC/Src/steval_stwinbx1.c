...
/** @defgroup STEVAL_STWINBX1 STEVAL_STWINBX1
 * @{
 */

/** @defgroup STEVAL_STWINBX1_LOW_LEVEL STEVAL_STWINBX1 LOW LEVEL
...
/** @defgroup STEVAL_STWINBX1_LOW_LEVEL_Private_Defines STEVAL_STWINBX1 LOW LEVEL Private Defines
 * @{
 */

/** @defgroup STEVAL_STWINBX1_LOW_LEVEL_FunctionPrototypes STEVAL_STWINBX1 LOW LEVEL Private Function Prototypes
 * @{
 */
...
/** @defgroup STEVAL_STWINBX1_LOW_LEVEL_Private_Variables STEVAL_STWINBX1 LOW LEVEL Private Variables
 * @{
 */
typedef void (* BSP_LED_GPIO_Init) (void);
static void LED_USER__ORANGE_GPIO_Init(void);
static void LED_USER__GREEN_GPIO_Init(void);
static GPIO_TypeDef*  LED_PORT[LEDn] = {LED_ORANGE_GPIO_PORT,LED_GREEN_GPIO_PORT,};
static const uint16_t LED_PIN[LEDn]  = {LED_ORANGE_PIN,LED_GREEN_PIN,};
...
{
  return (int32_t)__STEVAL_STWINBX1_BSP_VERSION;
}
...
{
  static const BSP_LED_GPIO_Init LedGpioInit[LEDn] = {LED_USER__ORANGE_GPIO_Init,LED_USER__GREEN_GPIO_Init,};
  LedGpioInit[Led]();
...
static void LED_USER__ORANGE_GPIO_Init(void) {
  ...
  HAL_GPIO_WritePin(BUS_BSP_LED__ORANGE_GPIO_PORT, BUS_BSP_LED__ORANGE_GPIO_PIN, GPIO_PIN_RESET);

  /*Configure GPIO pin : PTPIN */
  GPIO_InitStruct.Pin = BUS_BSP_LED__ORANGE_GPIO_PIN;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BUS_BSP_LED__ORANGE_GPIO_PORT, &GPIO_InitStruct);
