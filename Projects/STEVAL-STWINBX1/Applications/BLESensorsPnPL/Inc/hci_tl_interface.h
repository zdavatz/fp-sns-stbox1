...
#define HCI_TL_SPI_EXTI_PORT  GPIOF
#define HCI_TL_SPI_EXTI_PIN   GPIO_PIN_14
#define HCI_TL_SPI_EXTI_IRQn  EXTI14_IRQn

#define HCI_TL_SPI_IRQ_PORT   GPIOF
#define HCI_TL_SPI_IRQ_PIN    GPIO_PIN_14

#define HCI_TL_SPI_CS_PORT    GPIOE
