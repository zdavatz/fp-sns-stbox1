...
/**  Definition for BSP USER LED _ORANGE   **/

#define BUS_GPIO_INSTANCE GPIO
#define BUS_BSP_LED__ORANGE_GPIO_CLK_ENABLE() __HAL_RCC_GPIOH_CLK_ENABLE()
#define BUS_BSP_LED__ORANGE_GPIO_PORT GPIOH
#define BUS_BSP_LED__ORANGE_GPIO_PIN GPIO_PIN_10
#define BUS_BSP_LED__ORANGE_GPIO_CLK_DISABLE() __HAL_RCC_GPIOH_CLK_DISABLE()

#define LED_ORANGE_PIN                          GPIO_PIN_10
#define LED_ORANGE_GPIO_PORT                    GPIOH
#define LED_ORANGE_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOH_CLK_ENABLE()
#define LED_ORANGE_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOH_CLK_DISABLE()

/**  Definition for BSP USER LED _GREEN   **/

#define BUS_GPIO_INSTANCE GPIO
#define BUS_BSP_LED__GREEN_GPIO_CLK_ENABLE() __HAL_RCC_GPIOH_CLK_ENABLE()
#define BUS_BSP_LED__GREEN_GPIO_PORT GPIOH
#define BUS_BSP_LED__GREEN_GPIO_PIN GPIO_PIN_12
#define BUS_BSP_LED__GREEN_GPIO_CLK_DISABLE() __HAL_RCC_GPIOH_CLK_DISABLE()

#define LED_GREEN_PIN                          GPIO_PIN_12
#define LED_GREEN_GPIO_PORT                    GPIOH
#define LED_GREEN_GPIO_CLK_ENABLE()            __HAL_RCC_GPIOH_CLK_ENABLE()
#define LED_GREEN_GPIO_CLK_DISABLE()           __HAL_RCC_GPIOH_CLK_DISABLE()
...
#define BUS_GPIO_INSTANCE GPIO
#define BUS_BSP_BUTTON_GPIO_CLK_ENABLE() __HAL_RCC_GPIOE_CLK_ENABLE()
#define BUS_BSP_BUTTON_GPIO_PIN GPIO_PIN_0
#define BUS_BSP_BUTTON_GPIO_CLK_DISABLE() __HAL_RCC_GPIOE_CLK_DISABLE()
#define BUS_BSP_BUTTON_GPIO_PORT GPIOE
 ...
 * @}
 */
/** @defgroup STEVAL_STWINBX1_LOW_LEVEL_COM STEVAL_STWINBX1 LOW LEVEL COM
 * @{
 */
/**
