/**
  ******************************************************************************
  * @file    stm32wb07_06_events_cb.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Event callbacks for external uC - stm32wb07_06 in network coprocessor
  *          mode
  ******************************************************************************
  * @attention
  *
                                                    ...
                                                    uint8_t reason))
{
   ...
   */
  STM32WB07_06_PRINTF("hci_disconnection_complete_event\r\n");
                                               ...
                                               uint8_t encryption_enabled))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_encryption_change_event\r\n");
}
/**
                                                                      ...
                                                                      uint16_t subversion))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_read_remote_version_information_complete_event\r\n");
}
/**
...
WEAK_FUNCTION(void hci_hardware_error_event(uint8_t hardware_code))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_hardware_error_event\r\n");
}
/**
                                                         ...
                                                         handle_packets_pair_entry_t handle_packets_pair_entry[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_number_of_completed_packets_event\r\n");
}
/**
...
WEAK_FUNCTION(void hci_data_buffer_overflow_event(uint8_t link_type))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_data_buffer_overflow_event\r\n");
}
/**
                                                             ...
                                                             uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_encryption_key_refresh_complete_event\r\n");
}
...
WEAK_FUNCTION(void hci_authenticated_payload_timeout_expired_event(uint16_t onnection_Handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_authenticated_payload_timeout_expired_event\r\n");
}
                                                    ...
                                                    uint8_t master_clock_accuracy))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_connection_complete_event\r\n");
}
/**
                                                   ...
                                                   advertising_report_t advertising_report[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_advertising_report_event\r\n");
}
/**
                                                           ...
                                                           uint16_t supervision_timeout))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_connection_update_complete_event\r\n");
}
/**
                                                                   ...
                                                                   uint8_t le_features[8]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_read_remote_used_features_complete_event\r\n");
}
/**
                                                      ...
                                                      uint16_t encrypted_diversifier))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_long_term_key_request_event\r\n");
}
/**
                                                   ...
                                                   uint16_t max_rx_time))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_data_length_change_event\r\n");
}
/**
                                                                    ...
                                                                    uint8_t local_p256_public_key[64]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_read_local_p256_public_key_complete_event\r\n");
}
/**
                                                        ...
                                                        uint8_t dh_key[32]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_generate_dhkey_complete_event\r\n");
}
/**
                                                             ...
                                                             uint8_t master_clock_accuracy))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_enhanced_connection_complete_event\r\n");
}
/**
                                                          ...
                                                          direct_advertising_report_t direct_advertising_report[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_direct_advertising_report_event\r\n");
}
/**
  * @}
  */
...
WEAK_FUNCTION(void aci_gap_limited_discoverable_event(void))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_limited_discoverable_event\r\n");
}
/**
                                                  ...
                                                  uint8_t reason))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_pairing_complete_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gap_pass_key_req_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_pass_key_req_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gap_authorization_req_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_authorization_req_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gap_slave_security_initiated_event(void))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_slave_security_initiated_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gap_bond_lost_event(void))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_bond_lost_event\r\n");
}
/**
                                               ...
                                               uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_proc_complete_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gap_addr_not_resolved_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_addr_not_resolved_event\r\n");
}
/**
                                                          ...
                                                          uint32_t numeric_value))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_numeric_comparison_value_event\r\n");
}
/**
                                                       ...
                                                       uint8_t notification_type))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gap_keypress_notification_event\r\n");
}
                                                     ...
                                                     uint8_t attr_data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_attribute_modified_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gatt_proc_timeout_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_proc_timeout_event\r\n");
}
/**
                                                   ...
                                                   uint16_t server_rx_mtu))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_exchange_mtu_resp_event\r\n");
}
/**
                                                ...
                                                uint8_t handle_uuid_pair[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_find_info_resp_event\r\n");
}
/**
                                                         ...
                                                         attribute_group_handle_pair_t attr_group_handle_pair[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_find_by_type_value_resp_event\r\n");
}
/**
                                                   ...
                                                   uint8_t handle_value_pair_data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_read_by_type_resp_event\r\n");
}
/**
                                           ...
                                           uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_read_resp_event\r\n");
}
/**
                                                ...
                                                uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_read_blob_resp_event\r\n");
}
/**
                                                    ...
                                                    uint8_t set_of_values[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_read_multiple_resp_event\r\n");
}
/**
                                                         ...
                                                         uint8_t attribute_data_list[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_read_by_group_type_resp_event\r\n");
}
/**
                                                    ...
                                                    uint8_t part_attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_prepare_write_resp_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_att_exec_write_resp_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_exec_write_resp_event\r\n");
}
/**
                                                ...
                                                uint8_t error_code))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_proc_complete_event\r\n");
}
/**
                                             ...
                                             uint8_t error_code))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_error_resp_event\r\n");
}
/**
                                                              ...
                                                              uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_disc_read_char_by_uuid_resp_event\r\n");
}
/**
                                                   ...
                                                   uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_write_permit_req_event\r\n");
}
/**
                                                  ...
                                                  uint16_t offset))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_read_permit_req_event\r\n");
}
/**
                                                    ...
                                                    uint16_t available_buffers))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_tx_pool_available_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gatt_server_confirmation_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_server_confirmation_event\r\n");
}
/**
                                                           ...
                                                           uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_prepare_write_permit_req_event\r\n");
}
/**
  * @}
  */
                                                          ...
                                                          uint16_t result))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_connection_update_resp_event\r\n");
}
/**
                                                ...
                                                uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_proc_timeout_event\r\n");
}
/**
                                                         ...
                                                         uint16_t timeout_multiplier))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_connection_update_req_event\r\n");
}
/**
  * @brief This event is generated when the master responds to the connection update request packet
                                                  ...
                                                  uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_command_reject_event\r\n");
}
/**
  * @}
  */
...
WEAK_FUNCTION(void aci_blue_initialized_event(uint8_t reason_code))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_blue_initialized_event reason_code=%x\r\n", reason_code);
}
/**
...
WEAK_FUNCTION(void aci_blue_events_lost_event(uint8_t lost_events[8]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_blue_events_lost_event\r\n");
}
/**
                                             ...
                                             uint8_t debug_data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_blue_crash_info_event\r\n");
}
/**
                                                       ...
                                                       uint32_t next_state_sys_time))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_hal_end_of_radio_activity_event\r\n");
}
/**
                                                 ...
                                                 uint8_t peer_address[6]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_hal_scan_req_report_event\r\n");
}
/**
                                          ...
                                          uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_hal_fw_error_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_hal_le_test_end_event(uint16_t number_of_packets))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_hal_le_test_end_event\r\n");
}
/**
                                                  ...
                                                  uint16_t initial_credits))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_cfc_connection_event\r\n");
}
/**
                                                          ...
                                                          uint16_t cid))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_disconnection_complete_event\r\n");
}
/**
                                                       ...
                                                       uint16_t tx_credit_balance))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_flow_control_credit_event\r\n");
}
/**
                                                   ...
                                                   uint16_t tx_credit_balance))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_sdu_data_tx_nwk_event\r\n");
}
/**
                                                   ...
                                                   uint8_t sdu_data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_l2cap_sdu_data_rx_nwk_event\r\n");
}
/**
                                                         ...
                                                         uint8_t attr_data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_srv_attribute_modified_event\r\n");
}
/**
                                                    ...
                                                    uint8_t handle_uuid_pair[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_find_info_resp_event\r\n");
}
/**
                                                             ...
                                                             attribute_group_handle_pair_t *attr_group_handle_pair))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_find_by_type_value_resp_event\r\n");
}
/**
                                                       ...
                                                       uint8_t handle_value_pair_data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_read_by_type_resp_event\r\n");
}
/**
                                               ...
                                               uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_read_resp_event\r\n");
}
/**
                                                    ...
                                                    uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_read_blob_resp_event\r\n");
}
/**
                                                        ...
                                                        uint8_t set_of_values[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_read_multiple_resp_event\r\n");
}
/**
                                                             ...
                                                             uint8_t attribute_data_list[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_read_by_group_type_resp_event\r\n");
}
/**
                                                        ...
                                                        uint8_t part_attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_prepare_write_resp_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_att_clt_exec_write_resp_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_clt_exec_write_resp_event\r\n");
}
/**
                                                 ...
                                                 uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_clt_indication_event\r\n");
}
/**
                                                   ...
                                                   uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_clt_notification_event\r\n");
}
/**
                                                    ...
                                                    uint8_t error_code))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_clt_proc_complete_event\r\n");
}
/**
                                                 ...
                                                 uint8_t error_code))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_clt_error_resp_event\r\n");
}
/**
                                                                  ...
                                                                  uint8_t attribute_value[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_clt_disc_read_char_by_uuid_resp_event\r\n");
}
/**
...
WEAK_FUNCTION(void aci_gatt_srv_confirmation_event(uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_srv_confirmation_event\r\n");
}
/**
                                                    ...
                                                    uint8_t flags))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_att_srv_exec_write_req_event\r\n");
}
/**
                                                    ...
                                                    uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("aci_gatt_srv_authorize_nwk_event\r\n");
}
/**
                                                    ...
                                                    uint8_t rx_phy))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_phy_update_complete_event\r\n");
}
/**
                                                            ...
                                                            extended_advertising_report_t extended_adv_report[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_extended_advertising_report_event\r\n");
}
/**
                                                                      ...
                                                                      uint8_t advertiser_clock_accuracy))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_periodic_advertising_sync_established_event\r\n");
}
/**
  * @brief The LE Periodic Advertising Report event indicates that the Controller
  *        has received a Periodic Advertising packet. The sync_handle parameter
                                                            ...
                                                            uint8_t data[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_periodic_advertising_report_event\r\n");
}
/**
...
WEAK_FUNCTION(void hci_le_periodic_advertising_sync_lost_event(uint16_t sync_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_periodic_advertising_sync_lost_event\r\n");
}
/**
...
WEAK_FUNCTION(void hci_le_scan_timeout_event(void))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_scan_timeout_event\r\n");
}
/**
                                                           ...
                                                           uint8_t num_completed_extended_advertising_events))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_advertising_set_terminated_event\r\n");
}
/**
                                                      ...
                                                      uint8_t scanner_address[6]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_scan_request_received_event\r\n");
}
/**
                                                            ...
                                                            uint8_t channel_selection_algorithm))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_channel_selection_algorithm_event\r\n");
}
/**
                                                         ...
                                                         samples_t Samples[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_connectionless_iq_report_event\r\n");
}
/**
                                                     ...
                                                     samples_t Samples[]))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_connection_iq_report_event\r\n");
}
/**
                                                   ...
                                                   uint16_t connection_handle))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_cte_request_failed_event\r\n");
}
/**
                                                                            ...
                                                                            uint8_t advertiser_clock_accuracy))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_periodic_advertising_sync_transfer_received_event\r\n");
}
/**
                                                    ...
                                                    uint8_t zone_entered))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_path_loss_threshold_event\r\n");
}
/**
                                                         ...
                                                         int8_t delta))
{
  /* NOTE : This function Should not be modified, when needed,
            the callback could be implemented in the user file
   */
  STM32WB07_06_PRINTF("hci_le_transmit_power_reporting_event\r\n");
}
/**
  * @}
  */
