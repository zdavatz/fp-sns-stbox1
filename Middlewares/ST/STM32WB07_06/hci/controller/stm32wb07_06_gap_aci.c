/**
  ******************************************************************************
  * @file    stm32wb07_06_gap_aci.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Source file for external uC - stm32wb07_06 in network coprocessor mode (gap_aci)
...
#include "ble_types.h"
#include "stm32wb07_06_gap_aci.h"
#include "hci_tl.h"
                                          ...
                                          uint8_t actual_address[6])
{
  ...
  STM32WB07_06_MEMCPY((void *) actual_address, (const void *) resp.actual_address, 6);
  return BLE_STATUS_SUCCESS;
}
                                        ...
                                        bonded_device_entry_t bonded_device_entry[])
{
  ...
  *num_of_addresses = BTOH(resp.num_of_addresses, 1);
  STM32WB07_06_MEMCPY((void *) bonded_device_entry, (const void *) resp.bonded_device_entry,
                                  ...
                                  uint8_t oob_data[16])
{
  ...
  *address_type = BTOH(resp.address_type, 1);
  STM32WB07_06_MEMCPY((void *) address, (const void *) resp.address, 6);
  *oob_data_len = BTOH(resp.oob_data_len, 1);
  STM32WB07_06_MEMCPY((void *) oob_data, (const void *) resp.oob_data, 16);
  return BLE_STATUS_SUCCESS;
}
                                  ...
                                  uint8_t oob_data[16])
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->oob_data, (const void *) oob_data, 16);
  index_input += 16;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ext_aci = TRUE;
  rq_t.ogf = 0x3f;
                                                             ...
                                                             list_entry_t list_entry[])
{
  ...
  /* var_len_data input */
  {
    for (uint32_t index = 0; index < num_of_list_entries; index++)
    {
      ...
      STM32WB07_06_MEMCPY((void *) &cp0->list_entry[index].peer_address,
