/**
  ******************************************************************************
  * @file    stm32wb07_06_l2cap_aci.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Source file for external uC - stm32wb07_06 in network coprocessor mode (l2cap_aci)
...
#include "ble_types.h"
#include "stm32wb07_06_l2cap_aci.h"
#include "hci_tl.h"
                                             ...
                                             uint8_t sdu_data[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->sdu_data, (const void *) sdu_data, sdu_length * sizeof(uint8_t));
