/**
  ******************************************************************************
  * @file    stm32wb07_06_hal_aci.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Source file for external uC - stm32wb07_06 in network coprocessor mode (hal_aci)
...
#include "ble_types.h"
#include "stm32wb07_06_hal_aci.h"
#include "hci_tl.h"
                                       ...
                                       uint8_t value[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->value, (const void *) value, length * sizeof(uint8_t));
                                      ...
                                      uint8_t data[])
{
  ...
  *data_length = BTOH(resp.data_length, 1);
  STM32WB07_06_MEMCPY((void *) data, (const void *) resp.data, *data_length * sizeof(uint8_t));
  return BLE_STATUS_SUCCESS;
}
                                     ...
                                     uint16_t link_connection_handle[16 / 2])
{
  ...
  STM32WB07_06_MEMCPY((void *) link_status, (const void *) resp.link_status, 8);
  STM32WB07_06_MEMCPY((void *) link_connection_handle, (const void *) resp.link_connection_handle, 16);
  return BLE_STATUS_SUCCESS;
}
                                           ...
                                           uint8_t data[])
{
  ...
  STM32WB07_06_MEMCPY((void *) data, (const void *) resp.data, (rq_t.rlen - 1)*sizeof(uint8_t));
  return BLE_STATUS_SUCCESS;
}
                                     ...
                                     uint8_t data[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->data, (const void *) data, num_bytes * sizeof(uint8_t));
