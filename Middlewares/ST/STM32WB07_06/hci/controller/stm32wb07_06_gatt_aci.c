/**
  ******************************************************************************
  * @file    stm32wb07_06_gatt_aci.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Source file for external uC - stm32wb07_06 in network coprocessor mode (gatt_aci)
...
#include "ble_types.h"
#include "stm32wb07_06_gatt_aci.h"
#include "hci_tl.h"
                                          ...
                                          uint16_t *service_handle)
{
  ...
  /* var_len_data input */
  {
    ...
    STM32WB07_06_MEMCPY((void *) &cp0->Service_UUID, (const void *) Service_UUID, size);
    index_input += size;
    {
                                       ...
                                       uint16_t *char_handle)
{
  ...
  /* var_len_data input */
  {
    ...
    STM32WB07_06_MEMCPY((void *) &cp0->char_uuid, (const void *) char_uuid, size);
    index_input += size;
    {
                                            ...
                                            uint16_t *char_desc_handle)
{
  ...
  /* var_len_data input */
  {
    ...
    STM32WB07_06_MEMCPY((void *) &cp0->char_desc_uuid, (const void *) char_desc_uuid, size);
    index_input += size;
    {
    ...
    index_input += 2;
    STM32WB07_06_MEMCPY((void *) &cp1->char_desc_value, (const void *) char_desc_value,
                   char_desc_value_length * sizeof(uint8_t));
                                                 ...
                                                 uint8_t value[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->value, (const void *) value, value_length * sizeof(uint8_t));
                                            ...
                                            uint8_t attribute_val[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->attribute_val, (const void *) attribute_val, attribute_val_length * sizeof(uint8_t));
                                                       ...
                                                       uuid_t *uuid)
{
  ...
  /* var_len_data input */
  {
    ...
    STM32WB07_06_MEMCPY((void *) &cp0->uuid, (const void *) uuid, size);
    index_input += size;
  }
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ext_aci = TRUE;
                                                ...
                                                uint8_t value[])
{
  ...
  *value_length = BTOH(resp.value_length, 2);
  STM32WB07_06_MEMCPY((void *) value, (const void *) resp.value, *value_length * sizeof(uint8_t));
  return BLE_STATUS_SUCCESS;
}
                                 ...
                                 uint8_t val[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->val, (const void *) val, val_length * sizeof(uint8_t));
                                             ...
                                             uint8_t data[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->data, (const void *) data, data_length * sizeof(uint8_t));
