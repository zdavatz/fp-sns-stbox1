/**
  ******************************************************************************
  * @file    stm32wb07_06_hci_le.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Source file for external uC - stm32wb07_06 in network coprocessor
                            ...
                            uint8_t reason)
{
  ...
  index_input += 1;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x01;
  rq_t.ocf = 0x006;
  rq_t.event = 0x0F;
...
ble_status_t hci_set_event_mask(uint8_t event_mask[8])
{
  ...
  ble_status_t status = 0;
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->event_mask, (const void *) event_mask, 8);
  index_input += 8;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x03;
  rq_t.ocf = 0x001;
                                           ...
                                           int8_t *transmit_power_level)
{
  ...
  STM32WB07_06_MEMSET(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  cp0->connection_handle = HTOB(connection_handle, 2);
  index_input += 2;
...
ble_status_t hci_set_event_mask_page_2(uint8_t event_mask_page_2[8])
{
  ...
  ble_status_t status = 0;
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->event_mask_page_2, (const void *) event_mask_page_2, 8);
  index_input += 8;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x03;
  rq_t.ocf = 0x063;
...
ble_status_t hci_read_local_supported_commands(uint8_t supported_commands[64])
{
  ...
  STM32WB07_06_MEMCPY((void *) supported_commands, (const void *) resp.supported_commands, 64);
  return BLE_STATUS_SUCCESS;
}
ble_status_t hci_read_local_supported_features(uint8_t lmp_features[8])
{
  ...
  STM32WB07_06_MEMCPY((void *) lmp_features, (const void *) resp.lmp_features, 8);
  return BLE_STATUS_SUCCESS;
}
ble_status_t hci_read_bd_addr(uint8_t bd_addr[6])
{
  ...
  STM32WB07_06_MEMCPY((void *) bd_addr, (const void *) resp.bd_addr, 6);
  return BLE_STATUS_SUCCESS;
}
...
ble_status_t hci_le_set_event_mask(uint8_t le_event_mask[8])
{
  ...
  ble_status_t status = 0;
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->le_event_mask, (const void *) le_event_mask, 8);
  index_input += 8;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x001;
...
ble_status_t hci_le_read_local_supported_features(uint8_t le_features[8])
{
  ...
  STM32WB07_06_MEMCPY((void *) le_features, (const void *) resp.le_features, 8);
  return BLE_STATUS_SUCCESS;
}
ble_status_t hci_le_set_random_address(uint8_t random_address[6])
{
  ...
  ble_status_t status = 0;
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->random_address, (const void *) random_address, 6);
  index_input += 6;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x005;
                                               ...
                                               uint8_t advertising_filter_policy)
{
  ...
  if (peer_address)
  {
    STM32WB07_06_MEMCPY((void *) &cp0->peer_address, (const void *) peer_address, 6);
  }
  index_input += 6;
                                         ...
                                         uint8_t advertising_data[31])
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->advertising_data, (const void *) advertising_data, 31);
  index_input += 31;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x008;
                                           ...
                                           uint8_t scan_response_data[31])
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->scan_response_data, (const void *) scan_response_data, 31);
  index_input += 31;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x009;
                                             ...
                                             uint8_t address[6])
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->address, (const void *) address, 6);
  index_input += 6;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x011;
...
ble_status_t hci_le_set_host_channel_classification(uint8_t le_channel_map[5])
{
  ...
  ble_status_t status = 0;
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->le_channel_map, (const void *) le_channel_map, 5);
  index_input += 5;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x014;
                                     ...
                                     uint8_t le_channel_map[5])
{
  ...
  STM32WB07_06_MEMCPY((void *) le_channel_map, (const void *) resp.le_channel_map, 5);
  return BLE_STATUS_SUCCESS;
}
                            ...
                            uint8_t encrypted_data[16])
{
  ...
  STM32WB07_06_MEMSET(&resp, 0, sizeof(resp));
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->key, (const void *) key, 16);
  index_input += 16;
  STM32WB07_06_MEMCPY((void *) &cp0->plaintext_data, (const void *) plaintext_data, 16);
  index_input += 16;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x017;
  ...
  STM32WB07_06_MEMCPY((void *) encrypted_data, (const void *) resp.encrypted_data, 16);
  return BLE_STATUS_SUCCESS;
}
ble_status_t hci_le_rand(uint8_t random_number[8])
{
  ...
  STM32WB07_06_MEMCPY((void *) random_number, (const void *) resp.random_number, 8);
  return BLE_STATUS_SUCCESS;
}
                                     ...
                                     uint8_t long_term_key[16])
{
  ...
  cp0->connection_handle = HTOB(connection_handle, 2);
  index_input += 2;
  STM32WB07_06_MEMCPY((void *) &cp0->random_number, (const void *) random_number, 8);
  index_input += 8;
  cp0->encrypted_diversifier = HTOB(encrypted_diversifier, 2);
  index_input += 2;
  STM32WB07_06_MEMCPY((void *) &cp0->long_term_key, (const void *) long_term_key, 16);
  index_input += 16;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x019;
...
ble_status_t hci_le_read_supported_states(uint8_t le_states[8])
{
  ...
  STM32WB07_06_MEMCPY((void *) le_states, (const void *) resp.le_states, 8);
  return BLE_STATUS_SUCCESS;
}
...
ble_status_t hci_le_generate_dhkey(uint8_t remote_p256_public_key[64])
{
  ...
  ble_status_t status = 0;
  uint8_t index_input = 0;
  STM32WB07_06_MEMCPY((void *) &cp0->remote_p256_public_key, (const void *) remote_p256_public_key, 64);
  index_input += 64;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x026;
                                                 ...
                                                 uint8_t local_irk[16])
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->peer_identity_address, (const void *) peer_identity_address, 6);
  index_input += 6;
  STM32WB07_06_MEMCPY((void *) &cp0->peer_irk, (const void *) peer_irk, 16);
  index_input += 16;
  STM32WB07_06_MEMCPY((void *) &cp0->local_irk, (const void *) local_irk, 16);
  index_input += 16;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x027;
                                                 ...
                                                 uint8_t peer_resolvable_address[6])
{
  ...
  STM32WB07_06_MEMCPY((void *) peer_resolvable_address, (const void *) resp.peer_resolvable_address, 6);
  return BLE_STATUS_SUCCESS;
}
                                                  ...
                                                  uint8_t local_resolvable_address[6])
{
  ...
  STM32WB07_06_MEMCPY((void *) local_resolvable_address, (const void *) resp.local_resolvable_address, 6);
  return BLE_STATUS_SUCCESS;
}
                                                       ...
                                                       uint8_t advertising_random_address[6])
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->advertising_random_address, (const void *) advertising_random_address, 6);
  index_input += 6;
  STM32WB07_06_MEMSET(&rq_t, 0, sizeof(rq_t));
  rq_t.ogf = 0x08;
  rq_t.ocf = 0x035;
                                                        ...
                                                        int8_t *selected_tx_power)
{
  ...
  index_input += 2;
  STM32WB07_06_MEMCPY((void *) &cp0->primary_advertising_interval_min, (const void *) primary_advertising_interval_min, 3);
  index_input += 3;
  STM32WB07_06_MEMCPY((void *) &cp0->primary_advertising_interval_max, (const void *) primary_advertising_interval_max, 3);
  index_input += 3;
                                                  ...
                                                  uint8_t advertising_data[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->advertising_data,
                                                    ...
                                                    uint8_t scan_response_data[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->scan_response_data,
                                                     ...
                                                     uint8_t sync_cte_type)
{
  ...
  index_input += 1;
  STM32WB07_06_MEMCPY((void *) &cp0->advertising_address, (const void *) advertising_address, 6);
  index_input += 6;
                                     ...
                                     uint8_t antenna_ids[])
{
  ...
  /* var_len_data input */
  {
    STM32WB07_06_MEMCPY((void *) &cp0->antenna_ids, (const void *) antenna_ids, switching_pattern_length * sizeof(uint8_t));
