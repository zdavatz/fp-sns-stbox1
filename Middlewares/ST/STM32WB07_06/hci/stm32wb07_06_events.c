/**
  ******************************************************************************
  * @file    stm32wb07_06_events.c
  * @author  System Research & Applications Team - Agrate/Catania Lab.
  * @version 1.0.0
  * @date    04-March-2025
  * @brief   Source file for external uC - stm32wb07_06 in network coprocessor mode
...
ble_status_t hci_le_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->num_reports; index++)
  {
    ...
    size += 1;
    STM32WB07_06_MEMCPY((void *) advertising_report[index].address,
...
ble_status_t hci_le_direct_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->num_reports; index++)
  {
    ...
    size += 1;
    STM32WB07_06_MEMCPY((void *) direct_advertising_report[index].address,
    ...
    size += 1;
    STM32WB07_06_MEMCPY((void *) direct_advertising_report[index].direct_address,
...
ble_status_t hci_le_extended_advertising_report_event_process(uint8_t *buffer_in)
{
  ...
  for (index = 0; index < rp0->num_reports; index++)
  {
    ...
    size += 1;
    STM32WB07_06_MEMCPY((void *) extended_adv_report[index].address,
    ...
    size += 1;
    STM32WB07_06_MEMCPY((void *) extended_adv_report[index].direct_address,
